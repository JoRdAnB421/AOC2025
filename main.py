...
def main():
    ...
    parser.add_argument("--extension", "-e", default="txt", help="Input file extension (default: txt)")
    parser.add_argument("--delimiter", "-d", default=None, help="Input delimiter (default: None)")
